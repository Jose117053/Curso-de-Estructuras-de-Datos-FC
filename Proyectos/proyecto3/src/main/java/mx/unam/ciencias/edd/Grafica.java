...
public class Grafica<T> implements Coleccion<T> {
    ...
    public Lista<VerticeGrafica<T>> dijkstra(T origen, T destino) {
        ...
        //si ve que modifique esto, es porque en la condicion de que monticulo será, eligia el de arreglo
        //esto entorpecia DEMASIADO el generar la solucion del laberinto
